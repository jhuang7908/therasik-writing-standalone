...
found_data = [
    {
        'antibody_name': 'Abrilumab',
        'discovery_source': 'transgenic_animal',
        'target': 'a4b7 integrin',
        'clinical_phase': 'Phase 2',
        'indication_text': 'IBD / UC',
        'ada_first_pct': 1.0,  # Estimated from "very low" (1/30 patients in Phase 1, approx 3%)
        'ada_value_display': '~1% - 3%',
    ...
    {
        'antibody_name': 'Afimkibart',
        'discovery_source': 'transgenic_animal',
        'target': 'TL1A',
        'clinical_phase': 'Phase 2/3',
        'indication_text': 'IBD',
        'ada_first_pct': 82.0,
        'ada_value_display': '82% (10% NAb)',
        'evidence_source': 'Phase 2a Literature (Search)',
        'assay_method': 'Unknown',
        'verify_status': 'WEB_SEARCH_VERIFIED',
        'ada_has_text_evidence': True
    }
