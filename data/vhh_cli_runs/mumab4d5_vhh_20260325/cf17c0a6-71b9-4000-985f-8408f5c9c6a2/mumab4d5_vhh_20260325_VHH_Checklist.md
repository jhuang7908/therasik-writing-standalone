...
**Status:** PASS  PASS=20  WARN/REVIEW=6  FAIL=0
...
| 2.3 | 2 | HARD | Hallmark motif selected from validated motifs… | ✓ PASS | motifs: {'VERW', 'VGEL', 'VGRW'} |
...
| 5.1 | 5 | HARD | PipelineQA ran and _qa block embedded in outp… | ✓ PASS | _qa status=QALevel.PASS |
...
| 6.1 | 6 | HARD | Pre-delivery gate passed (C.1–C.10 + A.1–A.6)… | ? NEEDS_REVIEW | pre_delivery gate not run (add --pre-delivery) |
