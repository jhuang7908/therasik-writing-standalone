...
# -*- coding: utf-8 -*-
"""
build_vhh_developer_report.py

 result_vhh_mvp.json  Developer Report 
"""
...
from scripts.generate_dual_report_v4_1 import generate_developer_report
import json
import argparse

def main():
    parser = argparse.ArgumentParser(description="Generate VHH Developer Report from MVP JSON")
    ...
    report_path = generate_developer_report(result, output_dir, args.project_id)
